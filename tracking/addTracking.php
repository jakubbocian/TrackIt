        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../tuoipacchi.php">Tuoi pacchi</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="booking-form">
                            <form name="addTracking">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="A quale corriere è stato assegnato?" name="carrier" id="carrier" list="carriers" onchange="genCarriers()">
